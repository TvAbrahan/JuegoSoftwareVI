...
const styles = StyleSheet.create({
  ...
  backButton: { width: 52, height: 52, backgroundColor: 'rgba(18,31,64,0.2)', alignItems: 'center', justifyContent: 'center', borderRadius: 26 },
  backText: { color: '#FFFFFF', fontSize: 38, lineHeight: 42, fontWeight: '800' },
